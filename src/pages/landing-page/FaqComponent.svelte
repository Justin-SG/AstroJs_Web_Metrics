			...
			>
				<h3 id="accordion-flush-heading-1">
					<button
                        ...
                        on:click={() => toggleBlock("accordion-flush-body-1")}
					>
					...
					<div class="py-5 border-b border-gray-200 dark:border-gray-700">
						...
						<p class="text-gray-500 dark:text-gray-400">
							Check out this guide to learn how to <a
								href="#top"
								class="text-purple-600 dark:text-purple-500 hover:underline">get started</a
				...
				<h3 id="accordion-flush-heading-2">
					<button
                        ...
                        on:click={() => toggleBlock("accordion-flush-body-2")}
					>
				...
				<h3 id="accordion-flush-heading-3">
					<button
                        ...
                        on:click={() => toggleBlock("accordion-flush-body-3")}
					>
				...
				<div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
					<div class="py-5 border-b border-gray-200 dark:border-gray-700">
						...
						<ul class="pl-5 text-gray-500 list-disc dark:text-gray-400">
							<li>
								<a href="#top" class="text-purple-600 dark:text-purple-500 hover:underline"
									>Landwind Pro</a
								>
							</li>
							<li>
				...
				<h3 id="accordion-flush-heading-4">
					<button
                        ...
                        on:click={() => toggleBlock("accordion-flush-body-4")}
					>
